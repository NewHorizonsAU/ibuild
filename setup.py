...
#
# However, when we do this, we also import `IBuild/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'IBuild_cli = IBuild.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'IBuild_gui = IBuild.gui:entry_point'
        # ]
    }
)
